...
const MainBottom = props => {
  ...
  const {ImageBottoms, currentUser} = useSelector(({authRed}) => authRed);
  console.log('ImageBottoms', ImageBottoms);
  let options = {
    mediaType: 'photo',
    maxWidth: 512,
    maxHeight: 512,
  ...
  let unselectedColor = '';
  global.navIndex = 0;
  global.themeIndex = ImageBottoms;
      ...
      screenOptions={{
        ...
        tabBarBackground: () => (
          <LinearGradient
            ...
            style={[styles.bottom, {borderColor: 'red'}]}
          />
        ),
          ...
          tabBarIcon: ({color}) => (
            <View style={[styles.icon, styles.touchstyle]}>
              <Image
                ...
                source={color == selectedColor ? iconsSelected[0] : icons[0]}
                key="selected"
              />
            </View>
          ),
        ...
        options={({route}) => ({
          ...
          tabBarIcon: ({color}) => (
            <View style={[styles.icon, styles.touchstyle]}>
              <Image
                style={[styles.icon_inside]}
                source={color == selectedColor ? iconsSelected[1] : icons[1]}
                key="selected"
              />
            </View>
          ),
        ...
        options={({route}) => ({
          ...
          tabBarIcon: ({color}) => (
            <View style={[styles.icon, styles.touchstyle]}>
              <Image
                style={[styles.icon_inside]}
                source={color == selectedColor ? iconsSelected[2] : icons[2]}
                key="selected"
              />
            </View>
          ),
        ...
        options={({route}) => ({
          ...
          tabBarIcon: ({color}) => (
            <View style={[styles.icon, styles.touchstyle]}>
              <Image
                style={[styles.icon_inside]}
                source={color == selectedColor ? iconsSelected[3] : icons[3]}
                key="selected"
              />
            </View>
          ),
