            ...
            fetch(global.address + 'SendOTP', {
                ...
                .then((responseJson) => {
                    ...
                    if (responseJson.Status == 200) {
                        navigation.navigate("VerifyEmail", {action: 'sign-up', email: email})
                    }
                }).catch((error) => {
                    Toast.show({
                        type: 'error',
    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: "5%", paddingTop: "5%", backgroundColor: '#0B0213' }}>
            <ScrollView style={{padding: 10}}>
                ...
                <Text style={[styles.textTheme, {marginTop: 10, marginBottom: 30}]}>Let's create an account on memee to enjoy memes.</Text>
                ...
                <View style={{ flexDirection: 'row', marginLeft: '2%' }}>
                    ...
                    <View style={{ width: '22%', justifyContent: 'center', alignItems: 'flex-end', marginLeft: "-4%", borderBottomColor: '#454545', borderBottomWidth: 1 }}>
                        {passwordShowHide == false ?
                            <TouchableOpacity onPress={() => setPasswordShowHide(!passwordShowHide)}>
                                <Image
                                    style={{ height: 24, width: 25, marginLeft: 0, marginTop: 15, tintColor: '#BABABA' }}
                                    resizeMode='stretch'
                ...
                <View style={{ flexDirection: 'row', marginLeft: '2%', }}>
                    ...
                    <View style={{ width: '22%', marginLeft: "-4%", justifyContent: 'center', alignItems: 'flex-end', borderBottomColor: '#454545', borderBottomWidth: 1 }}>
                        {confirmPasswordShowHide == false ?
                            <TouchableOpacity onPress={() => setConfirmPasswordShowHide(!confirmPasswordShowHide)}>
                                <Image
                                    style={{ height: 24, width: 25, marginLeft: 0, marginTop: 15, tintColor: '#BABABA' }}
                                    resizeMode='stretch'
                                    source={require('../../images/invisible.png')}
                ...
                <View style={{ flexDirection: 'row', alignSelf: 'center', marginTop: 20 }}>
                    ...
                    <Text style={[styles.txtdown2, { fontFamily: global.fontSelect }]} onPress={() => navigation.navigate("LoginScreen")}>Signin</Text>

                </View>

                <Text style={[styles.textTheme, { width: '80%', textAlign: 'center', alignSelf: 'center', marginTop: 10, marginBottom: 20 }]}>By continuing you agree Memee’s Terms of Services & Privacy Policy.</Text>
