...
import { View, Text, TouchableOpacity, MaskedViewIOS, Modal, Dimensions, StyleSheet, ScrollView, Image, FlatList, ImageBackground, ViewBase } from 'react-native';
...
export default function IconsScreen() {
    ...
    async function getIconFN() {
        ...
        await fetch(global.address + 'GetStoreItems/' + global.userData.user_id + "/icon", {
            method: 'get',
            headers: {
            ...
            .then(async (responseJson) => {
                ...
                for (let i = 0; i < responseJson.StoreItems.length; i++) {
                    ...
                    console.log("responseJson.StoreItems : ", responseJson.StoreItems[i].item_code)
                    responseJson.StoreItems[i].img = asignImageToProductsFN(responseJson.StoreItems[i].item_code, responseJson.StoreItems[i].type)[0].imag
            ...
            <ScrollView >
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) =>
                        <View style={{ width: (windowWidth * 90) / 100, backgroundColor: '#201F38', borderRadius: (windowWidth * 10) / 100, alignSelf: 'center', marginTop: 30 }}>
                            ...
                            <View>
                                <Image
                                    style={{ height: 90, width: '90%', alignSelf: 'center', marginBottom: 10 }}
                                    resizeMode='contain'
                                    source={item.img}
                                />
                            </View>
