...
import { View, Text, RefreshControl, TouchableOpacity, BackHandler, Dimensions, PermissionsAndroid, Modal, StyleSheet, ScrollView, Image, FlatList, ImageBackground, ViewBase } from 'react-native';
...
export default function Tournament(props) {
    ...
    const { coinsStored, ImageBottoms, notifications } = useSelector(({ authRed }) => authRed)
    ...
    return (
        <View style={{ flex: 1, backgroundColor: global.colorPrimary, marginBottom: 0, }}>

            <ScrollView style={{ marginBottom: -25 }}>
                <View style={styles.topView}>

                    <Text numberOfLines={1} style={{ width: '30%', fontSize: 20, fontWeight: '800', color: global.colorTextPrimary, marginLeft: 7, marginTop: 6, marginRight: 10, fontFamily: global.fontSelect }}>Tournament</Text>
                    <View style={{width: '70%', flexDirection: 'row', marginLeft:'auto'}}>
                        <TouchableOpacity onPress={() => setModalVisible(!modalVisible)} style={{ marginTop: 12, marginLeft: 'auto'  }}>
                            <Image
                ...
                <View style={{ flexDirection: 'row', backgroundColor: '#201E23', width: "93%", height: 60, alignSelf: 'center', borderRadius: 30, marginBottom: 20 }}>
                    ...
                    <TouchableOpacity onPress={() => SelectedBtnFN(1)} style={{ width: "33%", }}>
                        <View style={{ height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            >
                                <Text style={{ color: txtcolor1, fontFamily: global.fontSelect }}>Tournament</Text>
                            </LinearGradient>
                        </View>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => SelectedBtnFN(2)} style={{ width: "34%", }}>
                        <View style={{ height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}>
                            <LinearGradient
                                colors={[btncolor2_1, btncolor2_2]}
                                style={{ height: 60, width: '100%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', borderRadius: 30, }}
                            >
                                <Text style={{ color: txtcolor2, fontFamily: global.fontSelect }}>Store</Text>
                            </LinearGradient>
                        </View>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => SelectedBtnFN(3)} style={{ width: "33%", }}>
                        <View style={{ height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}>
                            <LinearGradient
                                colors={[btncolor3_1, btncolor3_2]}
                                style={{ height: 60, width: '100%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', borderRadius: 30, }}
                            >
                                <Text style={{ color: txtcolor3, fontFamily: global.fontSelect }}>Judge</Text>
                            </LinearGradient>
                        </View>
                    </TouchableOpacity>
