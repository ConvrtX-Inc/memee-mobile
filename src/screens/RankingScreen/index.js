        ...
        <View style={{ flex: 1, paddingHorizontal: "5%", paddingTop: "5%", backgroundColor: global.colorPrimary, }}>
            <ScrollView>
                ...
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <Text style={[styles.title, {fontFamily:global.fontSelect, color: global.colorIcon}]}>Rankings</Text>
                </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => (
                        <View>
                                <View style={{ width: '100%', marginTop: 15, marginBottom: 10, height: 50, borderRadius: 25, flexDirection: 'row', backgroundColor: '#292929', }} >
                                    <Image
                                    ...
                                    />
                                    <Image
                                        style={{ width: 75, height: 72, marginLeft: -79, marginTop: -10 }}
                                        resizeMode='stretch'
                                        source={require('../../images/triangle1.png')}
                                    />

                                    <Text style={{ color: '#fff', fontSize: 15, marginLeft: -55, fontFamily:global.fontSelect }}>{item.rank_name}</Text>

                                    <Image
                                        style={{ width: 25, height: 25, marginLeft: "18%", marginTop: 11 }}
                                        resizeMode='stretch'
                                        source={require('../../images/Coin.png')}
                                    />
                                    <Text style={{ color: '#fff', fontSize: 17, fontWeight: 'bold', marginTop: 11, marginLeft: '2%', fontFamily:global.fontSelect }}>{item.prize} Coins</Text>
                                </View>
                        </View>
                    )
                    }
