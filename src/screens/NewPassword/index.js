...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, Image, ToastAndroid, Modal, Pressable } from 'react-native';
    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: "5%", paddingTop: "5%", backgroundColor: '#0B0213' }}>
            <ScrollView>
                ...
                <Text style={{ fontFamily: global.fontSelect }}>Your new password must be different from previous used password</Text>
                ...
                <Text style={{ color: '#fff', marginLeft: '5%', marginTop: 20 }}>CONFIRM NEW PASSWORD</Text>
                <View style={{ flexDirection: 'row', marginLeft: '2%', }}>
                    <View style={{ width: '75%' }}>
                        <Input
                            placeholder="Password"
