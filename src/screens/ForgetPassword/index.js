...
import { View, StyleSheet, ScrollView, Text, Image, Dimensions, TouchableOpacity, TextInput } from 'react-native';
    ...
    function getOTPToReset() {
        ...
        .then((responseJson) => {
                ...
                if(responseJson.Status == 200){
                    navigation.navigate("VerifyEmail", {action: 'forget-password', email: email})
                    setLoading(false);
                }
                else{
                    Toast.show({
