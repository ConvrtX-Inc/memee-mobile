...
import { View, Text, RefreshControl, TextInput, PermissionsAndroid, Modal, TouchableOpacity, BackHandler, MaskedViewIOS, StyleSheet, ScrollView, Image, FlatList, ImageBackground, ViewBase } from 'react-native';
    ...
    return (
        <View style={{ flex: 1, backgroundColor: global.colorPrimary, marginBottom: 0, }}>
            ...
            <ScrollView style={{ marginBottom: 0 }}>
                <View style={styles.topView}>
                    ...
                    <TouchableOpacity>
                        <View style={{ width: 145, height: 38 }}>
                            <Text style={{ fontFamily: global.fontSelect, fontSize: 25, color: global.colorIcon, marginLeft: 10, marginTop: 4, }}>Explore</Text>
                        </View>
                    </TouchableOpacity>
                ...
                <View style={{ flexDirection: 'row', height: 55, width: "92%", backgroundColor: '#201E23', alignSelf: "center", borderRadius: 32 }}>
