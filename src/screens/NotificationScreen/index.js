...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, BackHandler, Image, ToastAndroid, Modal, Pressable } from 'react-native';
        ...
        <View style={{ flex: 1, paddingHorizontal: "5%", paddingTop: "5%", backgroundColor: global.colorPrimary }}>
            {/* <ScrollView> */}
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <Text style={[styles.title, {fontFamily:global.fontSelect, color: global.colorIcon}]}> Inbox</Text>
                </View>
                <View style={{ flexDirection: 'row', backgroundColor: '#201E23', width: "96%", height: 60, alignSelf: 'center', borderRadius: 30, marginBottom: 20 }}>

                    <TouchableOpacity onPress={() => SelectedBtnFN(1)} style={{ width: "50%", }}>
                        <View style={{ height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            >
                                <Text style={{ color: txtcolor1, fontFamily:global.fontSelect }}>Activity</Text>
                            </LinearGradient>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => SelectedBtnFN(2)} style={{ width: "50%", }}>
                        <View style={{ height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}>
                            <LinearGradient
                                colors={[btncolor2_1, btncolor2_2]}
                                style={{ height: 60, width: '100%', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', borderRadius: 30, }}
                            >
                                <Text style={{ color: txtcolor2, fontFamily:global.fontSelect }}>Message</Text>
                            </LinearGradient>
                        </View>
                    </TouchableOpacity>
                </View>
