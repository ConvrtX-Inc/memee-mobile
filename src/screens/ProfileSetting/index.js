...
import { View, Text, FlatList, TouchableOpacity, StyleSheet, Dimensions, ScrollView, Modal, Image, ImageBackground, } from 'react-native';
...
export default function ProfileSetting(props) {
    ...
    async function purchaseIconGet() {
        ...
        await fetch(global.address + 'GetPurchasedItems/' + global.userData.user_id + "/" + global.userData.download_number, {
            method: 'get',
            headers: {
            ...
            .then(async (responseJson) => {
                ...
                for (let i = 0; i < responseJson.PurchasedItems.length; i++) {
                    ...
                    if (responseJson.PurchasedItems[i].type == "profile_background") {
                        ...
                        valueToPush["purchase_id"] = responseJson.PurchasedItems[i].purchase_id;
                        valueToPush["type"] = responseJson.PurchasedItems[i].type;
                        if (global.itemCodeProfileBG == responseJson.PurchasedItems[i].item_code) {
                            valueToPush["isSelected"] = true;
                        }
                        else {
                            valueToPush["isSelected"] = false;
                        }
                        valueToPush["img"] = asignImageToProductsFN(responseJson.PurchasedItems[i].item_code, responseJson.PurchasedItems[i].type)
                    ...
                    if (responseJson.PurchasedItems[i].type == "background_overlay") {
                        ...
                        valueToPush["purchase_id"] = responseJson.PurchasedItems[i].purchase_id;
                        valueToPush["type"] = responseJson.PurchasedItems[i].type;
                        if (global.itemCodeOverLay == responseJson.PurchasedItems[i].item_code) {
                            valueToPush["isSelected"] = true;
                        }
                        else {
                            valueToPush["isSelected"] = false;
                    ...
                    if (responseJson.PurchasedItems[i].type == "icon") {
                        ...
                        valueToPush["purchase_id"] = responseJson.PurchasedItems[i].purchase_id;
                        valueToPush["type"] = responseJson.PurchasedItems[i].type;
                        valueToPush["img"] = asignImageToProductsFN(responseJson.PurchasedItems[i].item_code, responseJson.PurchasedItems[i].type)[0].imag
                    ...
                    if (responseJson.PurchasedItems[i].type == "font") {
                        ...
                        valueToPush["purchase_id"] = responseJson.PurchasedItems[i].purchase_id;
                        valueToPush["type"] = responseJson.PurchasedItems[i].type;
                        valueToPush["font"] = asignImageToProductsFN(responseJson.PurchasedItems[i].item_code, responseJson.PurchasedItems[i].type)[0].font
    ...
    async function btnDesignFN(btnNo) {
        ...
        else if (buttonPurchased[btnNo].item_code == "memee_theme_generic_button") {
    ...
    async function profileBgFN(index) {
        ...
        global.profileBGgl = asignImageToProductsFN(profileBackground[index].item_code, profileBackground[index].type)
        await AsyncStorage.setItem('@profileItemCode', profileBackground[index].item_code)
    ...
    async function OverlayFN(index) {
        ...
        await AsyncStorage.setItem('@overlayItemCodee', BackgroundOverLay[index].item_code);
        if (BackgroundOverLay[index].item_code == "memee_theme_white_background_overlay") {
        ...
        else if (BackgroundOverLay[index].item_code == "the_100_theme_background_overlay") {
        ...
        else if (BackgroundOverLay[index].item_code == "unicorn_theme_background_overlay") {
        ...
        else if (BackgroundOverLay[index].item_code == "space_theme_backgroung_overlay") {
        ...
        else if (BackgroundOverLay[index].item_code == "save_earth_theme_background_overlay") {
        ...
        else if (BackgroundOverLay[index].item_code == "new_year_theme_background_overlay") {
    ...
    async function bottomTabColorChangeFN(index) {
        ...
        await AsyncStorage.setItem('@bottOmIconItemCode', bottomTabicon[index].item_code)
    ...
    return (
        <View style={{ flex: 1, paddingLeft: "5%", paddingTop: "5%", backgroundColor: global.colorPrimary}}>
            <ScrollView>
                ...
                <Text style={{ color: global.colorTextPrimary, marginLeft: 5, marginBottom: 10, marginTop: 10, fontFamily: selectFonts, }}>Profile Background</Text>
                            ...
                            <TouchableOpacity onPress={() => profileBgFN(index)}>
                                <ImageBackground
                                    ...
                                    {item.isSelected == true ?
                                        <Image
                                            style={{ width: 25, height: 25, marginTop: 6, marginLeft: '4%' }}
                                            resizeMode='stretch'
                                    ...
                                    {item.img2 != '-1' ?
                                        <Image
                                            style={{ width: 33, height: 33, marginTop: 19, marginLeft: '19%' }}
                                            resizeMode='stretch'
                                            source={item.img2}
                                        />
                                        : null}
                ...
                <Text style={{ color: global.colorTextPrimary, marginLeft: 5, marginBottom: 10, marginTop: 10, fontFamily: selectFonts, }}>Background Overlay</Text>

                <FlatList
                    horizontal={true}
                    data={BackgroundOverLay}
                    renderItem={({ item, index }) =>
                        <View style={{ marginLeft: 10, width: 110, height: 165, borderRadius: 25, backgroundColor: item.color }}>
                ...
                <Text style={{ color: global.colorTextPrimary, marginLeft: 5, marginTop: 15, fontFamily: selectFonts, }}>Icons</Text>

                <TouchableOpacity style={{ alignSelf: 'center', height: 90, marginBottom: 9, }} onPress={() => bottomTabModelFN()}>
                ...
                <Text style={{ color: global.colorTextPrimary, marginLeft: 5, marginBottom: 10, marginTop: 10, fontFamily: selectFonts, }}>Buttons</Text>

                <TouchableOpacity onPress={() => setModalVisible(true)}>

                    <LinearGradient
                        colors={[btncolor1, btncolor2]}
                        style={{ width: '94%', height: 62, alignSelf: 'center', justifyContent: 'center', alignItems: 'center', borderRadius: 30 }}
                    >
                        <Text style={{ color: btnTextColor, fontSize: 17, fontFamily: selectFonts, }}>{btnText}</Text>
                    </LinearGradient>

                </TouchableOpacity>

                <Text style={{ color: global.colorTextPrimary, marginLeft: 5, marginBottom: 10, marginTop: 10, fontFamily: selectFonts, }}>Fonts</Text>

                <TouchableOpacity style={{ marginBottom: 15 }} onPress={() => setFontModalVisible(true)}>

                    <View style={{ borderColor: '#4A4A4A', borderWidth: 1, borderRadius: 40, width: '94%', height: 62, alignSelf: 'center', justifyContent: 'center', alignItems: 'center' }}>

                        <Text style={{ color: global.colorTextPrimary, fontSize: 17, fontFamily: selectFonts, }}>I love memee app</Text>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <Text style={[styles.modalText, { fontFamily: selectFonts, }]}>Custom Buttons</Text>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <Text style={[styles.modalText, { fontFamily: selectFonts, }]}>Custom Fonts</Text>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) =>
                                <TouchableOpacity
                                    ...
                                    style={{ borderColor: '#4A4A4A', borderWidth: 1, borderRadius: 40, marginTop: 20, width: 210, height: 62, alignSelf: 'center', justifyContent: 'center', alignItems: 'center' }}>

                                    <Text style={{ color: '#fff', fontSize: 17, fontFamily: item.font, }}>I love memee app</Text>
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <Text style={[styles.modalText, { fontFamily: selectFonts, }]}>Custom icons</Text>
