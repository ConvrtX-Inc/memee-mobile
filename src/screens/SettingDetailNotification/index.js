...
export default function SettingDetailNotification(props) {
    ...
    const [allowNotification, setAllowNotification] = useState(global.userData.appNotifications == 1);
    ...
    function topicNotificationFN() {
        ...
        if (allowNotification == true) {
            ...
            try {
                ...
                fetch(global.address + 'toggleAppNotificationsStatus/' + global.userData.user_id + '/0', {
                    method: 'get',
                    headers: {
            ...
            fetch(global.address + 'toggleAppNotificationsStatus/' + global.userData.user_id + '/1', {
                method: 'get',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
    ...
    return (
        <View style={{ flex: 1, paddingLeft: "5%", paddingTop: "5%", backgroundColor: global.colorPrimary }}>
            <ScrollView>
                ...
                {console.log("\n\n global.userData.appNotifications", global.userData.appNotifications)}
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <Text style={[styles.title, { fontFamily: global.fontSelect, color: global.colorIcon }]}>Notifications</Text>
                </View>
                ...
                <View style={{ marginTop: 15, paddingBottom: 10, width: "100%", height: 70, flexDirection: 'row', alignItems: 'center', borderBottomColor: '#1B1B1B', borderBottomWidth: 1 }}>
                    ...
                    <View style={{ width: '65%', height: 60, marginLeft: 10, justifyContent: 'center' }}>
                        <Text style={{ color: global.colorTextPrimary, fontSize: 16, fontWeight: 'bold', fontFamily: global.fontSelect }}> Push Notifications</Text>
                    ...
                    <View style={{ width: '15%', height: 60, marginLeft: 'auto', flexDirection: 'row' }}>
                        ...
                        <Switch
                            trackColor={{ false: global.colorTextSecondary, true: global.colorTextActive }}
