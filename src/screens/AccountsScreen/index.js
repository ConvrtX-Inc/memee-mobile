                    ...
                    <TouchableOpacity onPress={() => navigateToProfile(index)}>
                        <View style={{ marginTop: 15, paddingBottom: 10, width: "100%", height: 70, flexDirection: 'row', alignItems: 'center', borderBottomColor: '#1B1B1B', borderBottomWidth: 1 }}>
                            ...
                            <View style={{ width: '65%', height: 60, marginLeft: 10 }}>
                                <Text style={{ color: global.colorTextPrimary, fontSize: 16, fontWeight: 'bold', marginTop: 4 }}> {item.name}</Text>
                                <Text style={{ color: global.colorTextPrimary, fontSize: 13, marginTop: 2 }}>{item.bio}</Text>
                            </View>
