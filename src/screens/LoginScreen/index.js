    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: "5%", paddingTop: "5%", backgroundColor: '#0B0213' }}>
            <ScrollView>
                ...
                <Text style={[styles.textTheme, {marginTop: 10, marginBottom: 30}]}>Enter email and password to get signed in.</Text>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("ForgetPassword")}>
                    <Text style={[styles.txtdown2, { marginLeft: 'auto', marginRight: 20, marginBottom: '2%', fontFamily: global.fontSelect }]}>Forgot password?</Text>
                </TouchableOpacity>
                {indicatButton == false ?
                    <ButtonLarge
                        title="Sign in"
