...
function VerifyEmail({ navigation, route }) {
    ...
    function proceedSignUp() {
        ...
        let body = JSON.stringify({
            ...
            userImage: "https://memee-bucket.s3.amazonaws.com/posts%2F32886c6d-2c41-4a9b-bf5f-d47220140091.jpg",
            loginType: "Email"
        })
    ...
    return (
        <View style={styles.container}>
            <ScrollView  style={{padding: 10}}>
                ...
                <Text style={[styles.smallText, { fontFamily: global.fontSelect, color:'#C1C1C1' }]}>
                    Code is sent to 
                    <Text style={[styles.smallText, { fontFamily: global.fontSelect, fontWeight: 'bold' }]}> {email} </Text>
                </Text>
                ...
                />
                <Text style={[styles.smallText, { alignSelf: 'center', marginLeft: 0, marginTop: 0, fontFamily: global.fontSelect, color: '#C1C1C1' }]}>
                    Didn't receive code?
                </Text>
                <TouchableOpacity style={styles.resendButton}>
                    <Text style={[styles.resendText, { fontFamily: global.fontSelect, color: '#FFFFFF', fontWeight: 'bold' }]}>
                        Resend OTP
                    </Text>
