...
const ButtonLarge = ({ title, onPress, bgClrFirst, bgClrSecond, txtClr, font }) => {
    ...
    return (
        <TouchableOpacity
            ...
            >
                <Text style={{ textAlign: "center", fontFamily: font, fontSize: 16, color: txtClr, fontWeight: 'bold' }}>{title}</Text>
            </LinearGradient>
        </TouchableOpacity>
    );
}
